...
function TestiminialHeadings({ testimonialHeading, setTestimonialHeading, loading, submitHandler }) {

  const onchangeFeature = (e) => {
    const { name, value } = e.target
    setTestimonialHeading((prev) => ({ ...prev, [name]: value }))
  }

  console.log(testimonialHeading)
      ...
      <div className='main flex justify-center items-center h-full w-full'>
        <form className='form border border-slate-500/20 w-[600px] p-5 flex flex-col gap-4 rounded-md'>
          ...
          <TextField
            ...
            variant="outlined"
            name="title"
            value={testimonialHeading.title}
          ...
          <TextField
            ...
            variant="outlined"
            name="Descriptions"
            value={testimonialHeading.Descriptions}
            onChange={onchangeFeature}
            multiline
            rows={4}
            sx={{
          ...
          <div className="flex items-center gap-2">
            <Checkbox
              checked={testimonialHeading.item_ShowOnWebsite}
              onChange={(e) => setTestimonialHeading((prev) => ({ ...prev, item_ShowOnWebsite: e.target.checked }))}
              sx={{ m: 0, p: 0 }}
              size="small"
            />
          ...
          <div className='flex gap-2 justify-end'>
            <GradientButton
              onClick={() => submitHandler("TestimonialHeading")}
              // disabled={loading}
              loading={loading}
...
export default TestiminialHeadings
